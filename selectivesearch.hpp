...
namespace ss
{
    ...
    inline std::map<int, Region> extractRegions( const cv::Mat &img, std::shared_ptr<Universe> universe )
    {
    ...
    inline std::vector<cv::Rect> selectiveSearch( const cv::Mat &img, double scale = 1.0, double sigma = 0.8, int minSize = 50, int smallest = 1000, int largest = 270000, double distorted = 5.0 )
    {
