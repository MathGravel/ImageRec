...
* \version 3.0
* \date 
* \brief select critere to tell if it's could be an affordance
**/
...
#include "../recoImage/DetectedObject.h"
...
public:
    ...
    * \details Compares the distance between each objects and the hands. If their are affordances, returnes the vector of AffordanceTime
    ...
    * \param MatriceAffordance& ObjectsMat : object having a vector of AffordanceTime
    ...
    **/
    std::vector<AffordanceTime*> findAffordances(DetectedObjects& regions,
                                                 ...
                                                 MatriceAffordance& ObjectsMat,
												 bool removeLastValue);


    /**
    * \fn	addNull(MatriceAffordance &objectMat, bool supAtime)
    ...
    * \param MatriceAffordance &objectMat : object from the class ObjectMat
    * \param bool supAtime : boolean, indicates if more than a certain time passed since the start of the video
    **/
    std::vector<AffordanceTime*> addNull(MatriceAffordance &objectMat, bool removeLastValue);
    ...
    **/
    ...
    /**
     * \fn friend std::istream &operator>>(std::istream &is, ObjectAffordances &objaff)
     * \brief operator >>
     * \param is
     * \param objaff
     * \return
